<div class="card m-5">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12">
				<?=$this->Form->create($entity,["url" => ["controller" => "Useraccounts","action" => "addCheck"],"enctype" => "multipart/form-data"]);?>
				...
				<div class="form-group">
					...
					<input type="password" name="password" id="pass" class="form-control form-control-lg" placeholder="半角英数20文字以内で入力してください" required>
				</div>
				<div class="form-group">
					<label for="pass2">パスワード再確認</label>
					<input type="password" name="password2" id="pass2" class="form-control form-control-lg" placeholder="上記と同じ値を入力してください" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="longitude" id="longitude" class="form-control form-control-lg" placeholder="120～140の間で入力してください" requred>
				</div>
				<div class="form-group">
